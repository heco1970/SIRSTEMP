...
class AttemptsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_states_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'count' => 1,
                'suspenso' => '2020-06-08 11:00:17',
                'user_states_id' => 1,
                'created' => '2020-06-08 11:00:17',
                'modified' => '2020-06-08 11:00:17'
            ],
        ];
        parent::init();
    }
