  ...
  $(document).ready(function() {
    var writers = {
      ação: function(row) {
        ...
        var edit = '<a style="margin-left:2px" class="btn btn-warning mr-1" href="/user-perfis/edit/' + row.id + '" data-toggle="tooltip" data-placement="top" title="<?=__('Edit')?>"><i class="far fa-edit fa-fw"></i></a>'
