...
<h1 class="h3 mb-2 text-gray-800"><?=__('Registo de Equipas')?></h1>

<div class="card shadow mb-2">
    <div class="card-header py-3">
        <a class="btn btn-success btn-circle btn-lg" href="/teams/add"><i class="fas fa-plus"></i></a>
    ...
    $(document).ready(function() {
        var writers = {
            ação: function(row) {
                ...
                var dele = '<a class="btn btn-danger" onclick="return confirm('+"'Deseja mesmo apagar?'"+')" href="/teams/delete/' + row.id + 'data-toggle="tooltip" data-placement="top" title="<?=__('Delete')?>"><i class="fa fa-trash fa-fw"></i></a>'
