...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><?= __('Alterar Registo Seguro Tutelar Educativo') ?></h6>
    </div>
            ...
            <div class="form-row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->text('data_nascimento', ['id' => 'campoDataNascimento', 'label' => false, 'value' => h($tutelareducativo->data_nascimento->format('Y-m-d')), 'class' => 'form-control', 'type' => 'date']); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
            ...
            <div class="form-row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->text('data_inicio', ['id' => 'campoInicio', 'label' => false, 'value' => h($tutelareducativo->data_inicio->format('Y-m-d')), 'class' => 'form-control', 'type' => 'date']); ?>
                    </div>
                </div>
            </div>
        </div>
