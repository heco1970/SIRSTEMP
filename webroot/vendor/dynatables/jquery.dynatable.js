...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      perPageText: 'Mostar: ',
      pageText: 'Páginas: ',
      recordCountPageBoundTemplate: '{pageLowerBound} de {pageUpperBound} em',
      recordCountPageUnboundedTemplate: '{recordsShown} em',
      recordCountTotalTemplate: '{recordsQueryCount} registos',
      recordCountFilteredTemplate: ' (filtrado de {recordsTotal} num total de registos)',
      recordCountText: 'A mostrar',
      recordCountTextTemplate: '{text} {pageTemplate} {totalTemplate} {filteredTemplate}',
      recordCountTemplate: '<span id="dynatable-record-count-{elementId}" class="dynatable-record-count">{textTemplate}</span>',
      processingText: 'Carregar...'
    },
    dataset: {
      ajax: false,
      ajaxUrl: null,
